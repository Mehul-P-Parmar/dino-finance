...
import { JSBI, Pair, Percent } from '@dinofinance/sdk'
import { Button, Card as UIKitCard, CardBody, Text } from '@dinofinance/uikit'
        ...
        <UIKitCard>
          <CardBody>
            <AutoColumn gap="12px">
              <FixedHeightRow>
                <RowFixed>
                  <Text style={{ textTransform: 'uppercase', fontWeight: 600 }} fontSize="16px" color="textSubtle">
              ...
              <FixedHeightRow onClick={() => setShowMore(!showMore)}>
                ...
                <RowFixed>
                  <Text fontSize="16px">{userPoolBalance ? userPoolBalance.toSignificant(4) : '-'}</Text>
                </RowFixed>
              </FixedHeightRow>
              <AutoColumn gap="4px">
                <FixedHeightRow>
                  <Text fontSize="16px">{currency0.symbol}:</Text>
                  {token0Deposited ? (
                    <RowFixed>
                      <Text ml="6px" fontSize="16px">
                ...
                <FixedHeightRow>
                  <Text fontSize="16px">{currency1.symbol}:</Text>
                  {token1Deposited ? (
                    <RowFixed>
                      <Text ml="6px" fontSize="16px">
