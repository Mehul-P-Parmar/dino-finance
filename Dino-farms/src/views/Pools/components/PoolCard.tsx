...
import { Button, IconButton, useModal, AddIcon, Image } from '@dinofinance/uikit'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  return (
    <Card isActive={isCardActive} isFinished={isFinished && ogeeId !== 5}>
      {isFinished && ogeeId !== 5 && <PoolFinishedSash />}
      <div style={{ padding: '24px' }}>
        <CardTitle isFinished={isFinished && ogeeId !== 5}>
        ...
        <Label isFinished={isFinished && ogeeId !== 5} text={TranslateString(330, `${tokenName} earned`)} />
        <StyledCardActions>
          ...
          {account &&
            (needsApproval && !isOldOgee ? (
              ...
              <>
                ...
                <StyledActionSpacer />
                {!isOldOgee && (
                  <IconButton disabled={isFinished && ogeeId !== 5} onClick={onPresentDeposit}>
                    <AddIcon color="white" />
                  </IconButton>
                )}
              </>
